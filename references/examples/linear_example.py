...
url = s.add(actions.make("url", WFURLActionURL="https://api.weather.example.com/current?city=Seattle"))
...
temp = s.add(actions.make("getvalueforkey", WFDictionaryKey="temperature", WFInput=weather))

# Step 7: Show the result
s.add(actions.make("showresult", Text=temp.in_string("Current temperature: \ufffc\u00b0F")))
